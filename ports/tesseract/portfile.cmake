# pdf-mcp overlay of vcpkg's tesseract port (microsoft/vcpkg @ 9e593bb, tag
# 2026.07.29). The only change: built with DISABLE_ARCHIVE and DISABLE_CURL,
# and without the curl and libarchive dependencies (libarchive also pulled in
# OpenSSL). pdf-mcp hands Tesseract image files, never URLs or archives, so
# neither was reachable; dropping them shrinks the exe, its attack surface,
# and the licence list. The upstream patches below are unchanged.
vcpkg_from_github(
